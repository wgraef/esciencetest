...
To install esciencetest, do:

.. code-block:: console

  git clone https://github.com//esciencetest.git
  cd esciencetest
  pip install .
...
If you want to contribute to the development of eScienceTest,
have a look at the `contribution guidelines <CONTRIBUTING.rst>`_.

License
*******

Copyright (c) 2018, Wouter Graef
